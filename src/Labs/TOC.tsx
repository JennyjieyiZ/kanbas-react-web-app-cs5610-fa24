  ...
  return (
    ...
    <li className="nav-item"><a id="wd-a1" href="#/Labs/Lab1"
      ...
      <li className="nav-item"><a id="wd-a3" href="#/Labs/Lab3"
          ...
          className={`nav-link ${pathname.includes("Lab3") ? "active" : ""}`}>Lab 4</a></li>
    <li className="nav-item">
    ...
    <li className="nav-item">
      <a id="wd-k" href="https://github.com/JennyjieyiZ/kanbas-react-web-app-cs5610-fa24" className="nav-link">
        My GitHub
      </a>
    </li>
  </ul>
